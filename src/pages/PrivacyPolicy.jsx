    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 border-b border-gray-200 pb-10">
          ...
          />
          <h1 className="text-4xl md:text-5xl font-black text-[#1C1C1C]">Privacy Policy</h1>
          <p className="mt-3 text-gray-400 text-sm">Last updated on 9/5/2024</p>
        </div>
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-gray-600 text-sm leading-relaxed">
          ...
          <p>We use Your Personal data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy was generated by terms Feed App Privacy Policy Generator.</p>
          ...
          <Section title="Interpretation and Definitions">
            ...
            <SubSection title="Definitions">
              ...
              <ul className="list-disc ml-6 space-y-2 mt-3">
                ...
                <li><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to NMA PARTNERS INC.</li>
          ...
          <Section title="Collecting and Using Your Personal Data">
            <SubSection title="Types of Data Collected">
              <p className="font-semibold text-[#1C1C1C] mb-2">Personal Data</p>
            ...
            <SubSection title="Information Collected while Using the Application">
              <p>While using Our Application, in order to provide features of Our Application, we may collect, with Your prior permission: Information regarding your location.</p>
              <p className="mt-2">We use this information to provide features of Our Service, to improve and customize Our Service. The information may be uploaded to the Company's servers and/or a Service Provider's server or it may be simply stored on Your device.</p>
              <p className="mt-2">You can enable or disable access to this information at any time, through Your Device settings.</p>
            </SubSection>
          ...
          <Section title="Retention of Your Personal Data">
            ...
            <p className="mt-2">The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.</p>
          </Section>
          ...
          <Section title="Security of Your Personal Data">
            ...
            <p className="mt-2">The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies.</p>
          </Section>
          ...
          <Section title="Contact Us">
            ...
            <ul className="list-disc ml-6 mt-2">
              <li>By visiting this page on our website: <a href="https://www.nma-partners.com" className="text-[#A0654A] underline">www.nma-partners.com</a></li>
            </ul>
          </Section>
        </div>
...
function Section({ title, children }) {
  return (
    <div>
      <h2 className="text-lg font-black text-[#1C1C1C] mb-4 pt-2 border-t border-gray-100">{title}</h2>
...
function SubSection({ title, children }) {
  return (
    <div className="mb-4">
      <h3 className="text-sm font-bold text-[#1C1C1C] mb-2">{title}</h3>
      {children}
    </div>
  );
}